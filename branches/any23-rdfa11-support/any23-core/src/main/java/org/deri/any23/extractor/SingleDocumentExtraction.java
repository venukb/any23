...
public class SingleDocumentExtraction {
     ...
     * if <code>null</code> the {@link MemCopyFactory} will be used.
     *
    ...
    /**
     * Triggers the execution of all the {@link org.deri.any23.extractor.Extractor}
    ...
    /**
     * Check whether the given {@link DocumentSource} content activates of not at least an extractor.
     *
